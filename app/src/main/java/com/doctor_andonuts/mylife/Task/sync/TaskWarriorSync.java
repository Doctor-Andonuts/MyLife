package com.doctor_andonuts.mylife.Task.sync;
...
public class TaskWarriorSync extends AsyncTask<Void, Void, String> {
    ...
    private TaskListFragment _taskListFragment;

    private String TAG = "TaskWarriorSync";
    private Context _context;
    public TaskWarriorSync (TaskListFragment taskListFragment) {
        _taskListFragment = taskListFragment;
        _context = _taskListFragment.getContext();
